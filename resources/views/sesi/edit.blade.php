        ...
        <div class="col-12">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <form class="form" method="POST" action="{{ route('sesi.update', [$data->id]) }}">
                        @csrf
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 form-group">
                                ...
                                <input type="text" id="fp-date-time" class="form-control flatpickr-date-time flatpickr-input active" placeholder="YYYY-MM-DD HH:MM" name="mulai" value="{{ $data->mulai }}">
                            </div>
                            <div class="col-md-6 form-group">
                                <label for="fp-date-time">Sesi Mulai</label>
                                <input type="text" id="fp-date-time" class="form-control flatpickr-date-time flatpickr-input active" placeholder="YYYY-MM-DD HH:MM" name="selesai" value="{{ $data->selesai }}">
                            </div>
